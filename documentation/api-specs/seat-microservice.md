...
| `cabinCounts` | object | Seat count per cabin code, e.g. `{"J": 32, "W": 56, "Y": 281}`. May be `null` |
...
| `cabinCounts` | object | No | Seat count per cabin code, e.g. `{"J": 32, "W": 56, "Y": 281}` |
