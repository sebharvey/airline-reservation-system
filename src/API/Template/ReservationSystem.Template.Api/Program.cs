...
using ReservationSystem.Template.Api.Application.UseCases.DeleteTemplateItem;
using ReservationSystem.Template.Api.Application.UseCases.GetAllTemplateItems;
using ReservationSystem.Template.Api.Application.UseCases.GetTemplateItem;
using ReservationSystem.Template.Api.Domain.Repositories;
using ReservationSystem.Template.Api.Infrastructure.Persistence;
