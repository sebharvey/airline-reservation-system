...
namespace ReservationSystem.Microservices.Seat.Swagger;
...
internal sealed class OpenApiConfigurationOptions : DefaultOpenApiConfigurationOptions
{
    ...
    {
        Version = "1.0.0",
        Title = "Apex Air \u2013 Seat API",
        Description = "Manages aircraft types, seatmaps, seat pricing, and seat offers for the Apex Air reservation system."
    };
