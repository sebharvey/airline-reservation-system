...
public sealed class AuthFunction
{
    ...
    public async Task<HttpResponseData> Login(
        [HttpTrigger(AuthorizationLevel.Function, "post", Route = "v1/auth/login")] HttpRequestData req,
    ...
    public async Task<HttpResponseData> Verify(
        [HttpTrigger(AuthorizationLevel.Function, "post", Route = "v1/auth/verify")] HttpRequestData req,
        CancellationToken cancellationToken)
    {
    ...
    public async Task<HttpResponseData> Refresh(
        [HttpTrigger(AuthorizationLevel.Function, "post", Route = "v1/auth/refresh")] HttpRequestData req,
        CancellationToken cancellationToken)
    {
    ...
    public async Task<HttpResponseData> Logout(
        [HttpTrigger(AuthorizationLevel.Function, "post", Route = "v1/auth/logout")] HttpRequestData req,
        CancellationToken cancellationToken)
    {
    ...
    public async Task<HttpResponseData> ResetPasswordRequest(
        [HttpTrigger(AuthorizationLevel.Function, "post", Route = "v1/auth/password/reset-request")] HttpRequestData req,
        CancellationToken cancellationToken)
    {
    ...
    public async Task<HttpResponseData> ResetPassword(
        [HttpTrigger(AuthorizationLevel.Function, "post", Route = "v1/auth/password/reset")] HttpRequestData req,
        CancellationToken cancellationToken)
    {
