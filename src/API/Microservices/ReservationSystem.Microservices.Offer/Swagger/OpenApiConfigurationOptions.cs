...
namespace ReservationSystem.Microservices.Offer.Swagger;
...
internal sealed class OpenApiConfigurationOptions : DefaultOpenApiConfigurationOptions
{
    ...
    {
        Version = "1.0.0",
        Title = "Apex Air \u2013 Offer API",
        Description = "Manages flight inventory, fares, offers, and seat reservations for the Apex Air reservation system."
    };
