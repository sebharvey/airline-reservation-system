...
public interface IOfferRepository
{
    ...
    Task CreateHoldAsync(Guid inventoryId, Guid orderId, string cabinCode, int paxCount, string holdType = "Revenue", short? standbyPriority = null, CancellationToken ct = default);
