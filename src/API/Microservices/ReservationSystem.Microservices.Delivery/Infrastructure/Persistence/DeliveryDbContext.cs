...
public sealed class DeliveryDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Manifest>(entity =>
        {
            ...
            entity.Property(m => m.PassengerId).HasColumnType("int").IsRequired();
            entity.Property(m => m.SegmentId).HasColumnType("int").IsRequired();
            ...
            entity.Property(m => m.FlightStatus).HasColumnType("varchar(20)").HasMaxLength(20).IsRequired(false);
