...
namespace ReservationSystem.Microservices.Bags.Swagger;
...
internal sealed class OpenApiConfigurationOptions : DefaultOpenApiConfigurationOptions
{
    ...
    {
        Version = "1.0.0",
        Title = "Apex Air \u2013 Bags API",
        Description = "Manages baggage policies, pricing, and offers for the Apex Air reservation system."
    };
