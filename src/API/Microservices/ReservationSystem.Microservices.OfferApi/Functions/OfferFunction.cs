...
using ReservationSystem.Microservices.OfferApi.Application.UseCases.CreateOffer;
using ReservationSystem.Microservices.OfferApi.Application.UseCases.DeleteOffer;
using ReservationSystem.Microservices.OfferApi.Application.UseCases.GetAllOffers;
using ReservationSystem.Microservices.OfferApi.Application.UseCases.GetOffer;
using ReservationSystem.Microservices.OfferApi.Models.Mappers;
using ReservationSystem.Microservices.OfferApi.Models.Requests;
using System.Net;
using System.Text.Json;

namespace ReservationSystem.Microservices.OfferApi.Functions;
