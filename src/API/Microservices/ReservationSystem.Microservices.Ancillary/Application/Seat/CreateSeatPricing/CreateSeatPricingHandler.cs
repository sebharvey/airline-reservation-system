...
public sealed class CreateSeatPricingHandler
{
    ...
    {
        var entity = SeatPricing.Create(command.CabinCode, command.Description, command.Sequence, command.CurrencyCode, command.Price, command.ValidFrom, command.ValidTo);
