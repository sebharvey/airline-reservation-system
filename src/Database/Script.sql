...
BEGIN TRY
    ...
    DECLARE @OrderData1 NVARCHAR(MAX) =
        N'{"dataLists":{"passengers":[{"passengerId":"PAX-1","type":"ADT","givenName":"Amara","surname":"Okafor","dateOfBirth":"1988-03-22","gender":"Female","loyaltyNumber":"AX9876543","contacts":{"email":"amara.okafor@example.com","phone":"+447700900123"},"docs":[{"type":"PASSPORT","number":"PA1234567","issuingCountry":"GBR","expiryDate":"2030-01-01","nationality":"GBR"}]},{"passengerId":"PAX-2","type":"ADT","givenName":"Jordan","surname":"Taylor","dateOfBirth":"1987-07-22","gender":"Male","loyaltyNumber":null,"contacts":null,"docs":[{"type":"PASSPORT","number":"PA7654321","issuingCountry":"GBR","expiryDate":"2028-06-30","nationality":"GBR"}]}]},"orderItems":[{"orderItemId":"OI-1","type":"Flight","inventoryId":"'
    ...
    DECLARE @OrderData2 NVARCHAR(MAX) =
        N'{"dataLists":{"passengers":[{"passengerId":"PAX-1","type":"ADT","givenName":"James","surname":"Chen","dateOfBirth":"1979-11-05","gender":"Male","loyaltyNumber":"AX1234567","contacts":{"email":"james.chen@example.com","phone":"+447700900456"},"docs":[{"type":"PASSPORT","number":"PB9876543","issuingCountry":"GBR","expiryDate":"2031-05-30","nationality":"GBR"}]}]},"orderItems":[{"orderItemId":"OI-1","type":"Flight","inventoryId":"'
