...
-- delivery.Ticket -------------------------------------------------------------
-- One row per e-ticket (one passenger, all segments). All financial data lives in
-- TicketData.fareConstruction JSON (fareCalculationLine, baseFare, currency, taxes).
...
CREATE TABLE [delivery].[Manifest] (
    ...
    PassengerId      INT              NOT NULL,
    SegmentId        INT              NOT NULL CONSTRAINT DF_Manifest_SegmentId DEFAULT 0,
...
CREATE TABLE [seat].[SeatPricing] (
    ...
    Tax           DECIMAL(10,2)    NOT NULL CONSTRAINT DF_SeatPricing_Tax      DEFAULT 0.00,
...
CREATE TABLE [bag].[BagPricing] (
    ...
    Price        DECIMAL(10,2)    NOT NULL,
    Tax          DECIMAL(10,2)    NOT NULL CONSTRAINT DF_BagPricing_Tax      DEFAULT 0.00,
...
BEGIN TRY
    ...
    -- One ticket per passenger covering ALL segments. All financial data is stored in
    -- TicketData.fareConstruction JSON (fareCalculationLine, baseFare, currency, taxes).
    ...
    VALUES
    (@TktId1,@InvId_AX001,'AX001','2026-08-15','A351','1A', 'J','AB1234','932-1000000001',1,'Amara', 'Okafor','08:00','11:10'),
    (@TktId2,@InvId_AX001,'AX001','2026-08-15','A351','1K', 'J','AB1234','932-1000000002',2,'Jordan','Taylor','08:00','11:10'),
    (@TktId1,@InvId_AX002,'AX002','2026-08-25','A351','2A', 'J','AB1234','932-1000000001',1,'Amara', 'Okafor','13:00','01:15'),
    (@TktId2,@InvId_AX002,'AX002','2026-08-25','A351','2K', 'J','AB1234','932-1000000002',2,'Jordan','Taylor','13:00','01:15'),
    (@TktId3,@InvId_AX411,'AX411','2026-09-10','B789','22A','Y','JC0005','932-1000000003',1,'James', 'Chen',  '20:30','09:00');
